...
namespace FlyweightPattern.FlyweightDemoOne
{
    ...
    internal class TestDB
    {
        ...
        {
            AddInfoToList(ref colDB, "张三,人员列表,查看");
            AddInfoToList(ref colDB, "李四,人员列表,查看");
            AddInfoToList(ref colDB, "李四,薪资数据,查看");
            AddInfoToList(ref colDB, "李四,薪资数据,修改");

            for (int i = 0; i < 3; i++)
            {
                AddInfoToList(ref colDB, $"张三{i},人员列表,查看");
            }
